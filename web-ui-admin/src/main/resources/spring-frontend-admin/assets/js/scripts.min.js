                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            };getData('/api/v1/search/' + $this.find('.search-input').val(), {
                                offset: 0,
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'user':
                                getData('/books/user/' + $this.data('refreshid'), {
                                    offset: function() {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/api/v1/bookReview', {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/api/v1/rateBookReview', data, function (result) {
            ...
            return {
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/request-contact-confirmation', data, function (result) {
                            if (result.result) {
                    ...
                    $Registration.find('.form-input_code').on('blur', function () {
                        var $this = $(this), $row = $this.closest('.form-group_row'), data = {
                            ...
                            type: $row.find('.form-input_mail').val() != null ? 'mail' : 'phone'
                        }, $but = $row.find('.form-btn');
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approve-contact', data, function (result) {
                                if (result.result) {
                                    $this.attr('disabled', 'disabled');
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            $this.data('send', {contact: contact, type: $thisStep.find('.form-input_mail').not('.form-input_hide').val() != null ? 'mail' : 'phone'});
                            if (!error) {
                                postData('/send-login-otp', $this.data('send'), function (result) {
                                    if (result.result) {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            $this.data('send', {code: code, contact: send.contact,
                                type: $thisStep.find('[name="mailcode"]').not('.form-input_hide').val() != null ? 'OTP_EMAIL' : 'OTP_PHONE'
                            });
                            if (!error) {
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/api/v1/books/changeBookStatus', {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/api/v1/rateBook', {
