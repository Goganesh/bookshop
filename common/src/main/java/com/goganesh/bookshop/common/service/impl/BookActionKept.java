...
@Transactional
@Service
public class BookActionKept implements BookAction {
    ...
    public void execute(User user, List<Book> books) {
        ...
        for (Book book : books) {
             ...
             //} else {
                 //TOOD what if i found: same type, or different type
             //}
        }
    ...
    private Book2User createNewKeptBook2User(User user, Book book) {
        ...
        kept.setBook2UserType(book2UserTypeRepository.findByCode("KEPT").get());
